...
@esse
Cenário: Deve implementar o contador
	Dado que o valor do contador é 15
	Quando eu imclemntar em 3
	Então o valordo contador será 18
	
	Cenário: Deve implementar o contador
	Dado que o valor do contador é 123
	Quando eu imclemntar em 35
	Então o valordo contador será 158
